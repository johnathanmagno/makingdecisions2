...
for (i = 0; i < listOfNumbers.length; i++){
  if (listOfNumbers[i] % 3 === 0) {
    ...
    console.log(`${listOfNumbers[i]} is NOT divisible by 3 lol`)
  }
}
...
switch (letterGrade) {
  ...
  case "B":
    ...
    break;
  case "C":
    console.log('"The student is doing okayyyy."');
    break;
  case "D":
    console.log('"The student is not doing bery well."');
    break;
  case "F":
    console.log('"The student is failing but still smarter than mango"');
    break;
  default:
